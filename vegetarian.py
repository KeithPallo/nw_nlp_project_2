...
def makeVegetarian(ingredients, directions, kb):
    Substitutions = {'meats':{'ingredients':['extra-firm tofu, drained',
        ...
        'directions':['Cut tofu in half crosswise and again in half lengthwise.',
            ...
            'poultry':{'ingredients':['2 blocks firm or extra-firm tofu, well pressed',
                ...
                'directions':["First, prepare your tofu. Like most tofu recipes, tofu scramble will taste best if you press the tofu first. This allows the tofu to absorb more of the flavorings and seasonings which you add to it. It's an extra step, but it just takes a few minutes.",
                    ...
                    'fish':{'ingredients':['Oil',
                        ...
                        'directions':['put oil in pan',
                                      'place tempeh in pan',
                                      'season with old bay seasoning, lemon, and chopped up pieces of seaweed',
...
def findMeat(dish_name, ingredients, directions, hella_recipes):
...
# outputs: - list of new ingredients as strings
#          - list of new directions as strings
def undoVegetarian(dish_name, ingredients, directions, hella_recipes):
    ...
    vegetarian_foods = ['tofu', 'tempeh', 'seitan', 'vegan meat', 'jackfruit']

    clean_ingredients = []
    clean_directions = []

    possible_meats = findMeat(dish_name, ingredients, directions, hella_recipes)
    new_meat = 'beef'
    ...
    for ingredient in ingredients:
        ...
        for word in ingredient:
            if any(term == word for term in vegetarian_foods):
                vegan = True
        if not vegan:
            clean_ingredients.append(ingredient)
